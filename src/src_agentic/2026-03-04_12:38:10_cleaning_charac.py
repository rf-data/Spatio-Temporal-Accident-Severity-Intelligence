...
try:
    caracteristiques_2017_csv = pd.read_csv('caracteristiques_2017.csv')
except Exception as e:
    print("Error while loading 'caracteristiques_2017.csv': {e}")
scaler = StandardScaler()
caracteristiques_2017_csv['scaled_int'] = scaler.fit_transform(caracteristiques_2017_csv[['int']])
caracteristiques_2017_csv['scaled_atm'] = scaler.fit_transform(caracteristiques_2017_csv[['atm']])
caracteristiques_2017_csv['scaled_lat'] = scaler.fit_transform(caracteristiques_2017_csv[['lat']])
caracteristiques_2017_csv['scaled_long'] = scaler.fit_transform(caracteristiques_2017_csv[['long']])

caracteristiques_2017_csv['log_lat'] = np.log1p(caracteristiques_2017_csv['lat'])
caracteristiques_2017_csv['log_long'] = np.log1p(caracteristiques_2017_csv['long'])

# WARNING: No handler implemented for 'cardinality_action'

try:
    caracteristiques_2018_csv = pd.read_csv('caracteristiques_2018.csv')
except Exception as e:
    print("Error while loading 'caracteristiques_2018.csv': {e}")
scaler = StandardScaler()
caracteristiques_2018_csv['scaled_int'] = scaler.fit_transform(caracteristiques_2018_csv[['int']])
caracteristiques_2018_csv['scaled_atm'] = scaler.fit_transform(caracteristiques_2018_csv[['atm']])
caracteristiques_2018_csv['scaled_lat'] = scaler.fit_transform(caracteristiques_2018_csv[['lat']])
caracteristiques_2018_csv['scaled_long'] = scaler.fit_transform(caracteristiques_2018_csv[['long']])

caracteristiques_2018_csv['log_lat'] = np.log1p(caracteristiques_2018_csv['lat'])
caracteristiques_2018_csv['log_long'] = np.log1p(caracteristiques_2018_csv['long'])

# WARNING: No handler implemented for 'cardinality_action'

try:
    caracteristiques_2019_csv = pd.read_csv('caracteristiques_2019.csv')
except Exception as e:
    print("Error while loading 'caracteristiques_2019.csv': {e}")
scaler = StandardScaler()
caracteristiques_2019_csv['scaled_int'] = scaler.fit_transform(caracteristiques_2019_csv[['int']])
caracteristiques_2019_csv['scaled_atm'] = scaler.fit_transform(caracteristiques_2019_csv[['atm']])
caracteristiques_2019_csv['scaled_lat'] = scaler.fit_transform(caracteristiques_2019_csv[['lat']])
caracteristiques_2019_csv['scaled_long'] = scaler.fit_transform(caracteristiques_2019_csv[['long']])

caracteristiques_2019_csv['log_lat'] = np.log1p(caracteristiques_2019_csv['lat'])
caracteristiques_2019_csv['log_long'] = np.log1p(caracteristiques_2019_csv['long'])

# WARNING: No handler implemented for 'cardinality_action'

try:
    caracteristiques_2020_csv = pd.read_csv('caracteristiques_2020.csv')
except Exception as e:
    print("Error while loading 'caracteristiques_2020.csv': {e}")
scaler = StandardScaler()
caracteristiques_2020_csv['scaled_int'] = scaler.fit_transform(caracteristiques_2020_csv[['int']])
caracteristiques_2020_csv['scaled_atm'] = scaler.fit_transform(caracteristiques_2020_csv[['atm']])
caracteristiques_2020_csv['scaled_lat'] = scaler.fit_transform(caracteristiques_2020_csv[['lat']])
caracteristiques_2020_csv['scaled_long'] = scaler.fit_transform(caracteristiques_2020_csv[['long']])

caracteristiques_2020_csv['log_lat'] = np.log1p(caracteristiques_2020_csv['lat'])
caracteristiques_2020_csv['log_long'] = np.log1p(caracteristiques_2020_csv['long'])

# WARNING: No handler implemented for 'cardinality_action'

try:
    caracteristiques_2021_csv = pd.read_csv('caracteristiques_2021.csv')
except Exception as e:
    print("Error while loading 'caracteristiques_2021.csv': {e}")
scaler = StandardScaler()
caracteristiques_2021_csv['scaled_int'] = scaler.fit_transform(caracteristiques_2021_csv[['int']])
caracteristiques_2021_csv['scaled_atm'] = scaler.fit_transform(caracteristiques_2021_csv[['atm']])
caracteristiques_2021_csv['scaled_lat'] = scaler.fit_transform(caracteristiques_2021_csv[['lat']])

caracteristiques_2021_csv['log_lat'] = np.log1p(caracteristiques_2021_csv['lat'])
caracteristiques_2021_csv['log_long'] = np.log1p(caracteristiques_2021_csv['long'])

# WARNING: No handler implemented for 'cardinality_action'

try:
    caracteristiques_2022_csv = pd.read_csv('caracteristiques_2022.csv')
except Exception as e:
    print("Error while loading 'caracteristiques_2022.csv': {e}")
scaler = StandardScaler()
caracteristiques_2022_csv['scaled_int'] = scaler.fit_transform(caracteristiques_2022_csv[['int']])
caracteristiques_2022_csv['scaled_atm'] = scaler.fit_transform(caracteristiques_2022_csv[['atm']])
caracteristiques_2022_csv['scaled_lat'] = scaler.fit_transform(caracteristiques_2022_csv[['lat']])

caracteristiques_2022_csv['log_lat'] = np.log1p(caracteristiques_2022_csv['lat'])
caracteristiques_2022_csv['log_long'] = np.log1p(caracteristiques_2022_csv['long'])

# WARNING: No handler implemented for 'cardinality_action'

try:
    caract_2023_csv = pd.read_csv('caract_2023.csv')
except Exception as e:
    print("Error while loading 'caract_2023.csv': {e}")
scaler = StandardScaler()
caract_2023_csv['scaled_int'] = scaler.fit_transform(caract_2023_csv[['int']])
caract_2023_csv['scaled_atm'] = scaler.fit_transform(caract_2023_csv[['atm']])
caract_2023_csv['scaled_lat'] = scaler.fit_transform(caract_2023_csv[['lat']])

caract_2023_csv['log_lat'] = np.log1p(caract_2023_csv['lat'])
caract_2023_csv['log_long'] = np.log1p(caract_2023_csv['long'])

# WARNING: No handler implemented for 'cardinality_action'

try:
    caract_2024_csv = pd.read_csv('caract_2024.csv')
except Exception as e:
    print("Error while loading 'caract_2024.csv': {e}")
scaler = StandardScaler()
caract_2024_csv['scaled_int'] = scaler.fit_transform(caract_2024_csv[['int']])
caract_2024_csv['scaled_atm'] = scaler.fit_transform(caract_2024_csv[['atm']])
caract_2024_csv['scaled_lat'] = scaler.fit_transform(caract_2024_csv[['lat']])

caract_2024_csv['log_lat'] = np.log1p(caract_2024_csv['lat'])
caract_2024_csv['log_long'] = np.log1p(caract_2024_csv['long'])
